...
local BarrageAnim = Humanoid:LoadAnimation(Character.Stand.StandHumanoidRootPart.PunchBarrage)
local StrongPunchAnim = Humanoid:LoadAnimation(Character.Stand.StandHumanoidRootPart.StrongPunch)
...
Mouse.KeyDown:Connect(function(Key)
	...
	if (Key == "e") then
		...
		repeat
			...
			Replicated.Damage:FireServer(unpack({
				Humanoid,
				Character.Stand["Stand Left Arm"].CFrame * CFrame.new(0, -1, 0),
				0,
				0,
				Vector3.new(0, 0, 0),
				"rbxassetid://3909691881",
			...
			Replicated.Damage:FireServer(unpack({
				Humanoid,
				Character.Stand["Stand Right Arm"].CFrame * CFrame.new(0, -1, 0),
				0,
				0,
				Vector3.new(0, 0, 0),
				"rbxassetid://3909691881",
			...
			hito(Character.Stand["Stand Left Arm"], 45, 4, "rbxassetid://5256332728")
			hito(Character.Stand["Stand Right Arm"], 45, 4, "rbxassetid://5256332728")
		until released;
		connection:Disconnect();
		BarrageAnim:Stop()
		Attack = false;
	...
	if (Key == "v") then
		DoChargeAttack(Character.Stand["Stand Right Arm"], "v", StrongPunchAnim, 0.5)
	end
end)
